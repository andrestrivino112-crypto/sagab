...
public class FinanzasController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','SUPER_ADMIN')")
    public List<FinanzasDtos.ValorPendienteResponse> pendientes() {
        return service.valoresPendientes();
    }

    @PostMapping("/pendientes/{idEstudiante}/notificacion")
    @PreAuthorize("hasAnyRole('ADMIN','SUPER_ADMIN')")
    public ResponseEntity<Void> notificarPendiente(@PathVariable Long idEstudiante,
            @Valid @RequestBody FinanzasDtos.NotificacionValorPendienteRequest req) {
        service.notificarValoresPendientes(idEstudiante, req.mensaje());
